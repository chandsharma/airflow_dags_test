    ...
    def poke(self, context):
        try:
            ...
            result = subprocess.run(
                ["kubectl", "get", "sparkapplication", "spark-history-airflow5", "-o", "jsonpath={.status.applicationState.state}"],
...
submit_spark_job = KubernetesPodOperator(
    task_id='submit_spark_airflow5',
    name='submit-spark-airflow4',
    namespace='default',
...
wait_for_spark = SparkApplicationSensor(
    task_id="wait_for_spark_airflow5",
