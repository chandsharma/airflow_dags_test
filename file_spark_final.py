...
# Define the DAG
dag = DAG(
    "submit_spark_job_airflow_spark_k8s_dynamic",
...
submit_spark_job = SparkKubernetesOperator(
    ...
    namespace="default",
    application_file="https://vishalsparklogs.blob.core.windows.net/spark-logs/sparktest8.yaml",  # Path to the YAML file
...
monitor_spark_job = SparkKubernetesSensor(
    ...
    namespace="default",
    application_name="spark-history-airflow-spark-dynamic",  # Updated Spark application name
