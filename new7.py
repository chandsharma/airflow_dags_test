...
submit_spark_job = KubernetesPodOperator(
    task_id="submit_spark_airflow7",
    name="submit-spark-airflow7",
    namespace="default",
...
wait_for_spark = SparkApplicationSensor(
    task_id="wait_for_spark_airflow7",
    spark_application_name="spark-history-airflow7",  # Replace dynamically if needed
    namespace="default",
