    ...
    def poke(self, context):
        try:
            ...
            result = subprocess.run(
                ["kubectl", "get", "sparkapplication", "spark-history-airflow", "-o", "jsonpath={.status.applicationState.state}"],
...
wait_for_spark = SparkApplicationSensor(
    task_id="wait_for_spark_airflow4",
